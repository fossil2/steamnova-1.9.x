...
$LNG['ov_ac_error_4'] = "Wrong password!";
$LNG['ov_ac_error_5'] = "Wrong name!";
$LNG['ov_ac_password'] = "Password!";
...
//----------------------------------------------------------------------------//
// Debris
$LNG['tf_txt'] = "Collect debris fields in your vicinity. Send recyclers and extract the resources. By upgrading your research, you can explore further into the universe.";

//----------------------------------------------------------------------------//
//Anomalie
$LNG['find_deb_title'] = "Find debris fields";
//----------------------------------------------------------------------------//
//Anomaly
$LNG['ex_ex']                               = 'Anomaly';
$LNG['ex_em']                               = 'Extra mission in U700';
//----------------------------------------------------------------------------//
...
//----------------------------------------------------------------------------//
// Tutorial 
$LNG['tut_a01']                             = 'You are new to the universe. Use the tutorial to get familiar with the game. Complete tasks and take advantage of the rewards.';
$LNG['tut_ano']                             = 'Start the tasks. Use the bonuses to build your planets.';
$LNG['tut_tut']				                = 'Tutorial';
$LNG['tut_welcome']                         = 'Welcome to U700 Tutorial';
$LNG['tut_welcom_desc']                     = 'Are you new to U700 and dont know your way around? Or do you just want to earn credits? Here you will find what you are looking for in both cases!';
$LNG['tut_welcom_desc2']                    = 'During the game you will be given missions for which you will receive a reward';
$LNG['tut_welcom_desc3']                    = 'You can freely choose the order in which you complete them, but it is recommended that you complete the missions in order';
$LNG['tut_welcom_desc4']                    = 'At the end of a mission you will receive more information and the reward.';
$LNG['tut_welcom_desc5']                    = 'For every mission you complete, you will receive a bonus in Dark Matter, which will be immediately credited to your player account.';
$LNG['tut_objects']                         = 'Mission objectives';
$LNG['tut_go']                              = 'Start tutorial!';
$LNG['tut_go_to']                           = 'To';
$LNG['tut_m1']                              = ' 1';
$LNG['tut_m2']                              = ' 2';
$LNG['tut_m3']                              = ' 3';
...
$LNG['tut_m8']                              = ' 8';
$LNG['tut_m9']                              = ' 9';
$LNG['tut_ready']                           = '<font color="#00FF00">Completed!</font>';
$LNG['tut_not_ready']                       = '<font color="red">Still open!</font>';
$LNG['tut_m1_name']                         = 'Mission 1 - The primary resources';
$LNG['tut_m1_desc']                         = 'In order to successfully expand your planet, you must first ensure there is a sufficient resource base. Now optimize the production of your primary resources. Expand the metal mine and the crystal mine. But note that production requires a lot of energy so dont forget the solar power plant.<br><br>You can build if you select the item in the left menu: "Building".';
$LNG['tut_m1_quest']                        = 'Expansion of the metal mine to level 4';
$LNG['tut_m1_quest2']                       = 'Expansion of the crystal mine to level 2';
$LNG['tut_m1_quest3']                       = 'Expansion of the solar power plant on stage 4';
$LNG['tut_m1_quest4']                       = 'free';
$LNG['tut_m1_quest5']                       = 'free';
$LNG['tut_m1_gain']                         = '<font color="orange">Reward: 1000 Dark matter</font>';
$LNG['tut_m1_ready']                        = 'Congratulations you have completed mission 1 of the tutorial!<br>You already have 500 Obtaining Dark matter!';
$LNG['tut_m2_name']                         = 'Mission 2 - Defense of the planet';
$LNG['tut_m2_desc']                         = 'To ensure that your resources are protected from enemy attacks, you must build defenses. To find out what you need, you have to select “Technology” in the left menu. You will quickly realize that you need deuterium to put your plan into action. So start with a deuterium synthesizer... ';
$LNG['tut_m2_quest']                        = 'Expansion of the deuterium synthesizer at level 2';
$LNG['tut_m2_quest2']                       = 'Expansion of the robot factory to level 2';
$LNG['tut_m2_quest3']                       = 'Build a spaceship yard';
$LNG['tut_m2_quest4']                       = 'Build 10 rocket launchers';
$LNG['tut_m2_quest5']                       = 'Free';
$LNG['tut_m2_gain']                         = '<font color="orange">Reward: 1500 Dark matter</font>';
$LNG['tut_m2_ready']                        = 'Congratulations you have completed mission 2 of the tutorial!<br>You already have 1000 Obtaining Dark matter!';
$LNG['tut_m3_name']                         = 'Mission 3 - Optimize resource production';
$LNG['tut_m3_desc']                         = 'Its time to expand your mines to produce more of the resources you need. Always make sure you have enough energy available, otherwise production will be limited.';
$LNG['tut_m3_quest']                        = 'Expansion of the metal mine to level 10';
$LNG['tut_m3_quest2']                       = 'Expansion of the kristall mine to level 8';
$LNG['tut_m3_quest3']                       = 'Expansion of the deuterium synthesizer at level 5';
$LNG['tut_m3_quest4']                       = 'free';
$LNG['tut_m3_quest5']                       = 'free';
$LNG['tut_m3_gain']                         = '<font color="orange">Reward: 1800 Dark matter</font>';
$LNG['tut_m3_ready']                        = 'Congratulations you have completed mission 3 of the tutorial!<br>You already have 1500 Obtaining Dark matter!';
$LNG['tut_m4_name']                         = 'Mission 4 - The first spaceship';
$LNG['tut_m4_desc']                         = 'Spaceships can value you from enemies like rocket launchers. But they have an enormous advantage: you can of course also use them to attack. However, certain research must be present in order to build spaceships. So start your mission by building a research laboratory... ';
$LNG['tut_m4_quest']                        = 'Build a research laboratory';
$LNG['tut_m4_quest2']                       = 'Expansion of the spaceship yard to level 4';
$LNG['tut_m4_quest3']                       = 'Research the combustion engine up to level 2';
$LNG['tut_m4_quest4']                       = 'Build five small transporters';
$LNG['tut_m4_quest5']                       = 'free';
$LNG['tut_m4_gain']                         = '<font color="orange">Reward: 2000 Dark matter</font>';
$LNG['tut_m4_ready']                        = 'Congratulations you have completed mission 4 of the tutorial!<br>You already have 2000 Obtaining Dark matter!';
$LNG['tut_m5_name']                         = 'Mission 5 - Communication in the universe';
$LNG['tut_m5_desc']                         = 'You are not alone in the depths of the universe! It is of considerable importance to build a good communication network. This allows you to team up with other players and look for trading partners. Many players organize themselves into an alliance to support each other. Start looking for a suitable alliance by going to Alliances in the left menu. To find out which alliances already exist, it is a good idea to take a look at the statistics.';
$LNG['tut_m5_quest']                        = 'Become a member of an alliance';
$LNG['tut_m5_quest2']                       = 'Send a friend or teammate a friend request';
$LNG['tut_m5_quest3']                       = 'free';
$LNG['tut_m5_quest4']                       = 'free';
$LNG['tut_m5_quest5']                       = 'free';
$LNG['tut_m5_gain']                         = '<font color="orange">Reward: 2500 Dark matter</font>';
$LNG['tut_m5_ready']                        = 'Congratulations you have completed mission 5 of the tutorial!<br>You already have 2500 Obtaining Dark matter!';
$LNG['tut_m6_name']                         = 'Mission 6 - Resources and Defense';
$LNG['tut_m6_desc']                         = 'Now its time to invest valuable resources and take care of the defense. To save more resources, you should build camps. For defense it is advisable to build shield domes.';
$LNG['tut_m6_quest']                        = 'Build warehouses for metal, crystal and deuterium';
$LNG['tut_m6_quest2']                       = 'Build a small shield dome';
$LNG['tut_m6_quest3']                       = 'Build a big shield dome';
$LNG['tut_m6_quest4']                       = 'free';
$LNG['tut_m6_quest5']                       = 'free';
$LNG['tut_m6_gain']                         = '<font color="orange">Reward: 3000 Dark matter</font>';
$LNG['tut_m6_ready']                        = 'Congratulations you have completed mission 6 of the tutorial!<br>You already have 3000 Obtaining Dark matter!';
$LNG['tut_m7_name']                         = 'Misson 7 - Fleet movement';
$LNG['tut_m7_desc']                         = 'Another method to get resources is so called raiding. So the attack on another player. The risk that the enemy defense is stronger than your own fleet is very high. It is therefore advisable to spy on your opponents before an attack in order to find out how strong the opponent really is. Check out what you need to build a spy probe under Technology. Once you have built a probe, there are two ways to spy on someone:<br><br><font color="orange">In the Galaxy menu -> On the far left under Planet, move your mouse over the image and select Espionage</font><br><br><font color="orange">In the fleet menu -> New mission: Select spy probe</font>';
$LNG['tut_m7_quest']                        = 'Build 2 spy probes';
$LNG['tut_m7_quest2']                       = 'Spy on an opponents planet';
$LNG['tut_m7_quest3']                       = 'Research spy technology at level 2';
$LNG['tut_m7_quest4']                       = 'free';
$LNG['tut_m7_quest5']                       = 'free';
$LNG['tut_m7_gain']                         = '<font color="orange">Reward: 2700 Dark matter</font>';
$LNG['tut_m7_ready']                        = 'Congratulations you have completed mission 7 of the tutorial!<br>You already have 3500 Obtaining Dark matter!';
$LNG['tut_m8_name']                         = 'Mission 8 - Grow your empire';
$LNG['tut_m8_desc']                         = 'As Emperor, you are of course always interested in increasing your power. You can colonize new planets with the help of colony ships and transport goods between your planets with transport ships.';
$LNG['tut_m8_quest']                        = 'Build 2 colony ships on your current planet';
$LNG['tut_m8_quest2']                       = 'Start a colony';
$LNG['tut_m8_quest3']                       = 'Build 10 large transporters on your current planet';
$LNG['tut_m8_quest4']                       = 'free';
$LNG['tut_m8_quest5']                       = 'free';
$LNG['tut_m8_gain']                         = '<font color="orange">Reward: 2800 Dark matter</font>';
$LNG['tut_m8_ready']                        = 'Congratulations you have completed mission 8 of the tutorial!<br>You already have 4000 Obtaining Dark matter!';
$LNG['tut_m9_name']                         = 'Mission 9 - Debris Fields, Defense and Energy';
$LNG['tut_m9_desc']                         = 'fter a battle, the debris from destroyed ships and defenses forms debris fields in the planet orbit. Recyclers make it possible to dismantle these rubble fields and reuse the raw materials.<br><br>Now it time to build your war fleet, because reccours attract enemies.<br><br>But you should always keep an eye on your energy products and consumption, because without enough energy, your shipyards and mines will stop production.';
$LNG['tut_m9_quest']                        = 'Build 25 Recyclers on your current planet';
$LNG['tut_m9_quest2']                       = 'Mine a debris field';
$LNG['tut_m9_quest3']                       = 'Expand your fleet to 100 battleships on your current planet';
$LNG['tut_m9_quest4']                       = 'Ensure 2,000 available energy';
$LNG['tut_m9_quest5']                       = 'free';
$LNG['tut_m9_gain']                         = '<font color="Reward">Belohnung: 5000 Dark matter</font>';
$LNG['tut_m9_ready']                        = 'Congratulations you have completed mission 9 of the tutorial!<br>You already have 5000 Obtaining Dark matter!';
$LNG['tut_compleat']                        = 'You have successfully completed all missions!';
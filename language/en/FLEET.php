...
$LNG['fl_returning']                        = 'Your fleet is returning from %s %s [%s]. Resources: %s %s, %s %s, %s %s. Ships: %s';


$LNG['sys_stat_mess_stay']           		= 'Located fleet';
$LNG['sys_stat_mess']                    = 'Fleet from %s (%s) reaches %s %s (%s). Brought: %s %s, %s %s, %s %s. Ships: %s';

...
$LNG['registerSecretQuestionText'] = "Lütfen bir gizli soru seçiniz";
$LNG['registerSecretQuestionAnswerText'] = "Gizli sorunuza cevap veriniz";
$LNG['registerSecretQuestionArray'] = array(
  0 => 'Hangi şehirde doğdunuz?',
  1 => 'En sevdiğiniz evcil hayvanın adı nedir?',
  2 => "Annenizin kızlık soyadı nedir?",
  3 => "İlkokulunuzun adı nedir?",
  4 => "Ortaokulunuzun adı nedir?",
  5 => "İlk arabanız neydi?",
  6 => "En sevdiğiniz yemek nedir?"
);
$LNG['registerSecretQuestionError_1'] = "Yanlış bir gizli soru seçtiniz!";
$LNG['registerSecretQuestionError_2'] = "Gizli sorunun cevabı boş olamaz!";
$LNG['registerSecretQuestionError_3'] = "Gizli sorunun cevabı 64 karakterden uzun olamaz!";
...
//case default
$LNG['login_error_1'] = "E-Posta girilmedi!";
$LNG['login_error_2'] = "Şifre girilmedi!";
$LNG['login_error_3'] = "Kullanıcı bulunamadı!";
$LNG['login_error_4'] = "ReCaptcha doğru değil!";
$LNG['login_error_5'] = "Girilen şifre yanlış!";
//Rules

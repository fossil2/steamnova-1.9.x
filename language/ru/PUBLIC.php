...
$LNG['seoTitleIndex']               = 'U700 – Бесплатная космическая стратегия онлайн';
$LNG['seoDescriptionIndex']         = 'U700 — бесплатная космическая стратегическая онлайн-игра. Развивайте планеты, исследуйте новые технологии, создавайте флоты и соревнуйтесь с другими игроками.';
$LNG['seoKeywordsIndex']            = 'U700, космическая игра, браузерная игра, стратегическая игра, космическая стратегия онлайн, бесплатная онлайн игра, SteemNova, 2Moons';
...
$LNG['login_error_4'] = "ReCaptcha неверен!";
$LNG['login_error_5'] = "Пароль неверен!";
...
$LNG['loginServerDesc']             = '%s — бесплатная космическая стратегическая онлайн-игра, доступная прямо в браузере. Развивайте свои планеты, исследуйте новые технологии, стройте оборону и командуйте мощными флотами. Собирайте и управляйте ресурсами, основывайте новые колонии и сражайтесь с другими игроками в стратегических битвах. Всё, что вам нужно, — современный веб-браузер, без скачивания и установки.';
...
$LNG['registerSecretQuestionText'] = "Пожалуйста, выберите секретный вопрос";
$LNG['registerSecretQuestionAnswerText'] = "Ответьте на ваш секретный вопрос";
$LNG['registerSecretQuestionArray'] = array(
  0 => 'В каком городе вы родились?',
  1 => 'Как зовут вашего любимого питомца?',
  2 => "Какова девичья фамилия вашей матери?",
  3 => "Как называется ваша начальная школа?",
  4 => "Как называется ваша средняя школа?",
  5 => "Какой была ваша первая машина?",
  6 => "Какое ваше любимое блюдо?"
);
$LNG['registerSecretQuestionError_1'] = "Вы выбрали неправильный секретный вопрос!";
$LNG['registerSecretQuestionError_2'] = "Ответ на секретный вопрос не может быть пустым!";
$LNG['registerSecretQuestionError_3'] = "Ответ на секретный вопрос не может быть длиннее 64 символов!";

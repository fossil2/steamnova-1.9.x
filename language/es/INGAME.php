...
$LNG['lm_flight_simulator'] = "Simulador de Vuelo";
$LNG['fs_flight_sim'] = "Sim. de Vuelo";
$LNG['fs_time'] = "Tiempo";
$LNG['fs_percantage'] = "%";
...
// Módulo mover
$LNG['cm_error_1'] = "¡No es posible recolectar en modo vacaciones!";
$LNG['cm_error_2'] = "¡No es posible recolectar recursos durante un ataque!";
$LNG['cm_error_3'] = "¡Límite de tiempo %s min!";
$LNG['cm_collect_mines_submit'] = "¡Asegurar recursos!";

// MODULE_AUTOEXPEDITION
$LNG['ae_autoexp'] = "Auto Expedición";
$LNG['ae_galaxy'] = "Galaxia";
$LNG['ae_system'] = "Sistema";
$LNG['ae_planet'] = "Planeta";
$LNG['ae_settings'] = "Configuraciones";
$LNG['ae_send'] = "¡Enviar Expedición!";
$LNG['ae_error_1'] = "¡No hay suficientes espacios de expedición!";
$LNG['ae_error_2'] = "¡No es posible realizar una expedición en modo vacaciones!";
$LNG['ae_error_3'] = "¡El Recaptcha es incorrecto!";
$LNG['ae_error_4'] = "¡No se encontró ninguna flota!";
$LNG['ae_success'] = "Flota(s) enviada(s) exitosamente a la misión de expedición.";
...
//Anomalie
$LNG['ex_ex']				                = 'Anomalie';
$LNG['ex_em']                               = 'Missão extra em U700';
//----------------------------------------------------------------------------//
// Debris
$LNG['tf_tf']    = 'Campo de escombros';
$LNG['tf_Find_Debris']  = 'encontrar Campo de escombros';
$LNG['tf_Show_Debris']  = 'espectáculo Campo de escombros';
$LNG['tf_range']        = 'Range';
//----------------------------------------------------------------------------//
// Tutorial 
$LNG['tut_tut']				    = 'Tutorial';
$LNG['tut_welcome']                         = 'Bienvenido al tutorial U700 in Space';
$LNG['tut_welcom_desc']                     = '¿Eres nuevo en U700 ecibirás un bono de materia oscura que se colocará inmediatamente en tu cuenta de jugador.';
$LNG['tut_objects']                         = 'Objetivos de la misión';
...
$LNG['tut_m8']                              = ' 8';
$LNG['tut_m9']                              = ' 9';
$LNG['tut_ready']                           = '<font color="#00FF00">Terminado!</font>';
$LNG['tut_not_ready']                       = '<font color="red">Todavia abierto!</font>';
$LNG['tut_m1_name']                         = 'Misión 1 - Los recursos primarios.';
$LNG['tut_m1_desc']                         = 'Para expandir con éxito su planeta, primero debe proporcionar recursos suficientes. Ahora optimice la producción de sus recursos primarios. Extiende la mina de metal y la mina de cristal. Pero tenga en cuenta que la producción consume mucha energía, así que no se olvide de la planta de energía solar. <br><br> Puede construir si selecciona en el menú de la izquierda el punto: "edificio".';
$LNG['tut_m1_quest']                        = 'Ampliación de la Mina de Metal en el nivel 4';
$LNG['tut_m1_quest2']                       = 'Ampliación de la Mina de Cristal en el nivel 2';
$LNG['tut_m1_quest3']                       = 'Ampliación de la Planta de Energía Solar en el nivel 4';
$LNG['tut_m1_quest4']                       = 'Gratis';
$LNG['tut_m1_quest5']                       = 'Gratis';
$LNG['tut_m1_gain']                         = '<font color="orange">Recompensa: 1000 Materia Oscura.</font>';
$LNG['tut_m1_ready']                        = 'Felicidades por haber completado la misión 1 del tutorial!<br>Ya has recibido 500 Materia Oscura!';
$LNG['tut_m2_name']                         = 'Misión 2 - Defensa del planeta.';
$LNG['tut_m2_desc']                         = 'Para asegurarte de que tus recursos estén protegidos de los ataques enemigos, debes construir defensas. Para saber lo que necesita, debe seleccionar el elemento "Tecnología" en el menú de la izquierda. Pronto descubrirá que necesita deuterio para poner su plan en acción. Así que empieza con un sintetizador de deuterio ...';
$LNG['tut_m2_quest']                        = 'Ampliación del Sintetizador de Deuterio al nivel 2';
$LNG['tut_m2_quest2']                       = 'Ampliación de la fábrica de robots a nivel 2';
$LNG['tut_m2_quest3']                       = 'Construir Hangar';
$LNG['tut_m2_quest4']                       = 'Contruir 10 Lanzamisiles';
$LNG['tut_m2_quest5']                       = 'Gratis';
$LNG['tut_m2_gain']                         = '<font color="orange">Recompensa: 1500 Materia Oscura.</font>';
$LNG['tut_m2_ready']                        = 'Felicidades por haber completado la misión 2 del tutorial.!<br>Ya has recibido 1000 Materia Oscura!';
$LNG['tut_m3_name']                         = 'Misión 3 - Optimizar la producción de recursos.';
$LNG['tut_m3_desc']                         = 'Es hora de expandir sus minas para producir más de los recursos que necesita. Siempre asegúrese de tener suficiente energía disponible, de lo contrario, la producción será limitada.';
$LNG['tut_m3_quest']                        = 'Ampliación de la Mina de Metal en el nivel 10';
$LNG['tut_m3_quest2']                       = 'Ampliación de la Mina de Cristal en el nivel 8';
$LNG['tut_m3_quest3']                       = 'Ampliación de la Planta de Energía Solar en el nivel 5';
$LNG['tut_m3_quest4']                       = 'Gratis';
$LNG['tut_m3_quest5']                       = 'Gratis';
$LNG['tut_m3_gain']                         = '<font color="orange">Recompensa: 1800 Materia Oscura.</font>';
$LNG['tut_m3_ready']                        = 'Felicidades por haber completado la misión 3 del tutorial!<br>Ya has recibido 1500 Materia Oscura!';
$LNG['tut_m4_name']                         = 'Misión 4 - La primera nave espacial.';
$LNG['tut_m4_desc']                         = 'Las naves espaciales pueden ser como lanzacohetes para los enemigos. Pero tienen una gran ventaja: por supuesto, también puedes usarlos para atacar. Sin embargo, ciertas investigaciones deben estar disponibles para construir naves espaciales. Comience su misión construyendo un laboratorio de investigación ...';
$LNG['tut_m4_quest']                        = 'Construir un laboratorio de investigación';
$LNG['tut_m4_quest2']                       = 'Construir Hangar hasta el nivel 4';
$LNG['tut_m4_quest3']                       = 'Investiga el Motor de Combustión hasta el nivel 2';
$LNG['tut_m4_quest4']                       = 'Construye 5 Nave pequeña de carga';
$LNG['tut_m4_quest5']                       = 'Gratis';
$LNG['tut_m4_gain']                         = '<font color="orange">Recompensa: 2000 Materia Oscura.</font>';
$LNG['tut_m4_ready']                        = 'Felicidades por haber completado la misión 4 del tutorial!<br>Ya has recibido 2000 Materia Oscura!';
$LNG['tut_m5_name']                         = 'Misión 5 - Comunicación en el Universo.';
$LNG['tut_m5_desc']                         = '¡No estás solo en las aguas poco profundas del universo! Es muy importante construir una buena red de comunicación. Esto le permitirá asociarse con otros jugadores y buscar socios comerciales. Muchos jugadores se organizan juntos en una alianza para apoyarse mutuamente. Vaya en busca de una alianza adecuada yendo a alianzas en el menú de la izquierda. Para saber qué alianzas ya existen, eche un vistazo a las estadísticas.';
$LNG['tut_m5_quest']                        = 'Hazte miembro de una alianza';
$LNG['tut_m5_quest2']                       = 'Haz una solicitud de amistad a un amigo o compañero de equipo';
$LNG['tut_m5_quest3']                       = 'Gratis';
$LNG['tut_m5_quest4']                       = 'Gratis';
$LNG['tut_m5_quest5']                       = 'Gratis';
$LNG['tut_m5_gain']                         = '<font color="orange">Recompensa: 2500 Materia Oscura.</font>';
$LNG['tut_m5_ready']                        = 'Felicidades por haber completado la misión 5 del tutorial.!<br>Ya has recibido 2500 Materia Oscura!';
$LNG['tut_m6_name']                         = 'Misión 6 - Recursos y Defensa';
$LNG['tut_m6_desc']                         = 'Ahora es el momento de invertir recursos valiosos y cuidar la defensa. Para ahorrar más recursos, debes construir campamentos. Para la defensa, se recomienda construir cúpulas blindadas.';
$LNG['tut_m6_quest']                        = 'Construir almacenes para metal, cristal y deuterio.';
$LNG['tut_m6_quest2']                       = 'Construye Cópula pequeña de protección';
$LNG['tut_m6_quest3']                       = 'Construye Cópula grande de protección';
$LNG['tut_m6_quest4']                       = 'Gratis';
$LNG['tut_m6_quest5']                       = 'Gratis';
$LNG['tut_m6_gain']                         = '<font color="orange">Recompensa: 2600 Materia Oscura.</font>';
$LNG['tut_m6_ready']                        = 'Felicidades por haber completado la misión 6 del tutorial!<br>Ya has recibido 3000 Materia Oscura!';
$LNG['tut_m7_name']                         = 'Misión 7 - Movimiento de Flota';
$LNG['tut_m7_desc']                         = 'Otra forma de conseguir recursos se llama asalto. Así que el ataque a otro jugador. El riesgo de que la defensa de tu oponente sea más fuerte que tu propia flota es muy alto. Por lo tanto, es recomendable espiar a tus oponentes antes de un ataque para descubrir qué tan fuerte es realmente el oponente. Bajo el encabezado Tecnología, mira lo que necesitas para construir una sonda espía. Una vez que haya construido una sonda, hay dos formas de espiar a alguien: <br><br><font color="orange"> En el menú de la galaxia -> a la izquierda, debajo de Planeta, pase el mouse sobre la imagen y seleccione Espionaje </font><br><br><font color="orange">En el menú Flota -> Nuevo orden: seleccione sonda espía </font>';
$LNG['tut_m7_quest']                        = 'Construir 2 Sondas de espionaje';
$LNG['tut_m7_quest2']                       = 'Espía el planeta de un oponente.';
$LNG['tut_m7_quest3']                       = 'Investiga Tecnología de espionaje al nivel 2';
$LNG['tut_m7_quest4']                       = 'Gratis';
$LNG['tut_m7_quest5']                       = 'Gratis';
$LNG['tut_m7_gain']                         = '<font color="orange">Recompensa: 2700 Materia Oscura.</font>';
$LNG['tut_m7_ready']                        = 'Felicidades por haber completado la misión 7 del tutorial!<br>Ya has recibido 3500 Materia Oscura!';
$LNG['tut_m8_name']                         = 'Misión 8 - Amplía tu imperio.';
$LNG['tut_m8_desc']                         = 'Por supuesto, como Emperador, siempre estás interesado en aumentar tu poder. Puede colonizar nuevos planetas con la ayuda de barcos coloniales y transportar mercancías entre sus planetas utilizando barcos de transporte.';
$LNG['tut_m8_quest']                        = 'Construye 2 naves Coloniales en tu planeta actual.';
$LNG['tut_m8_quest2']                       = 'Coloniza un planeta';
$LNG['tut_m8_quest3']                       = 'Contruye 10 Nave grande de carga en tu planeta actual.';
$LNG['tut_m8_quest4']                       = 'Gratis';
$LNG['tut_m8_quest5']                       = 'Gratis';
$LNG['tut_m8_gain']                         = '<font color="orange">Recompensa: 2800 Materia Oscura.</font>';
$LNG['tut_m8_ready']                        = 'Felicidades por haber completado la misión 8 del tutorial!<br>Ya has recibido 4000 Materia Oscura!';
$LNG['tut_m9_name']                         = 'Misión 9 - Campos de escombros, defensa y energía';
$LNG['tut_m9_desc']                         = 'Después de una pelea, los escombros de las naves y defensas destruidas forman campos de escombros en la órbita del planeta. Los recicladores pueden explotar estos campos de escombros y reutilizar los recursos. <br><br> Ahora es el momento de construir su flota, los recursos atraen enemigos. <br><br> Pero siempre debe mantener sus productos energéticos. y vigile el consumo, porque sin suficiente energía, sus astilleros y minas detienen la producción.';
$LNG['tut_m9_quest']                        = 'Construye 25 recicladores en tu planeta actual.';
$LNG['tut_m9_quest2']                       = 'Construir un campo de escombros';
$LNG['tut_m9_quest3']                       = 'Amplía tu flota a 100 Nave de batalla en tu planeta actual.';
$LNG['tut_m9_quest4']                       = 'La Energía disponible 2,000';
$LNG['tut_m9_quest5']                       = 'Gratis';
$LNG['tut_m9_gain']                         = '<font color="orange">Recompensa: 5000 Materia Oscura.</font>';
$LNG['tut_m9_ready']                        = 'Felicidades por haber completado la misión 9 del tutorial!<br>Ya has recibido 5000 Materia Oscura!';
$LNG['tut_compleat']                        = 'Has completado con éxito toda las misiones!';

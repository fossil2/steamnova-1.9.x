...
$LNG['fl_returning1']                       = 'Deine Flotte kehrt von %s %s [%s] zurück. Rohstoffe: %s %s, %s %s, %s %s. Schiffe: %s';
...
$LNG['sys_stat_mess']                       = 'Flotte von %s (%s) erreicht %s %s (%s). Mitgebracht: %s %s, %s %s, %s %s. Schiffe: %s';
...
$LNG['sys_expe_found_ress_logbook_2']        = 'Eintrag aus dem Logbuch der Ersten Offiziere: Wenn wir nur ein paar Frachtschiffe mehr hätten! Jetzt müssen wir jede Menge Ressourcen zurücklassen.';
...
$LNG['sys_expe_found_ress_logbook_4']		=' Eintrag aus dem Logbuch des Ersten Offiziers: Selbst als wir die Cafeteria und alle Aufenthaltsräume in Lagerräume umgewandelt haben, können wir immer noch nicht alle gefundenen Ressourcen transportieren. ';
...
$LNG['sys_destruc_reussi']      		   	= 'Die Strahlen der Todessterne erreichen den Mond und zerfetzen ihn.<br>Der gesamte Mond wurde zerstört.<video controls width="250"><source src="/media/mond.webm" /></video>';

...
$LNG['lm_flight_simulator'] = "Simulador de Voo";
$LNG['fs_flight_sim'] = "Sim. de Voo.";
$LNG['fs_time'] = "Tempo";
$LNG['fs_percantage'] = "%";
$LNG['fs_time_hours'] = "Hora";
$LNG['fs_time_seconds'] = "Segundo";
$LNG['fs_time_minutes'] = "Minuto";


//Mover módulo
$LNG['cm_error_1'] = "Não é possível consolidar em modo de férias!";
$LNG['cm_error_2'] = "Não é possível consolidar recursos durante um ataque!";
$LNG['cm_error_3'] = "Limite de tempo %s min!";
$LNG['cm_collect_mines_submit'] = "Proteger Recursos!";


//MODULE_AUTOEXPEDITION
$LNG['ae_autoexp'] = "Expedição Automática";
$LNG['ae_galaxy'] = "Galáxia";
$LNG['ae_system'] = "Sistema";
$LNG['ae_planet'] = "Planeta";
$LNG['ae_settings'] = "Configurações";
$LNG['ae_send'] = "Enviar Expedição!";
$LNG['ae_error_1'] = "Slots de expedição insuficientes!";
$LNG['ae_error_2'] = "Não é possível realizar expedições em modo de férias!";
$LNG['ae_error_3'] = "Recaptcha incorreto!";
$LNG['ae_error_4'] = "Nenhuma frota encontrada!";
$LNG['ae_success'] = "Frota(s) enviada(s) com sucesso para a missão de expedição!";
//módulo de relocação
...
//----------------------------------------------------------------------------//
//Tutorial
$LNG['tut_a01']                             = 'Você é novo no universo. Use o tutorial para se familiarizar com o jogo. Complete as tarefas e aproveite as recompensas.';
$LNG['tut_ano']	                            = 'Inicie as tarefas. Use os bônus para desenvolver seus planetas.';
$LNG['tut_tut']				                = 'Tutorial';
$LNG['tut_welcome']                         = 'Bem-vindo ao Tutorial U700';
$LNG['tut_welcom_desc']                     = 'Você é novo no U700 e está perdido? Ou apenas quer ganhar créditos? Em ambos os casos, você está no lugar certo!';
$LNG['tut_welcom_desc2']                    = 'Durante o jogo, você receberá missões que, ao serem concluídas, te darão recompensas.';
$LNG['tut_welcom_desc3']                    = 'Você pode escolher a ordem em que realiza as missões, mas é recomendado segui-las na sequência sugerida.';
$LNG['tut_welcom_desc4']                    = 'No final de cada missão, você receberá mais informações e a recompensa.';
$LNG['tut_welcom_desc5']                    = 'Para cada missão concluída, você receberá um bônus de Matéria Escura, que será creditado automaticamente na sua conta.';
// $LNG['tut_objects']                         = 'Objetivos das missões';
$LNG['tut_objects']                         = 'Conclua as seguintes missões';
$LNG['tut_go']                              = 'Iniciar tutorial!';
$LNG['tut_go_to']                           = 'Ir para';
$LNG['tut_m1']                              = 'I';
$LNG['tut_m2']                              = 'II';
$LNG['tut_m3']                              = 'III';
$LNG['tut_m4']                              = 'IV';
...
$LNG['tut_m8']                              = 'VIII';
$LNG['tut_m9']                              = 'IX';
$LNG['tut_ready']                           = '<font color="#00FF00">Concluído!</font>';
$LNG['tut_not_ready']                       = '<font color="red">Ainda pendente!</font>';
$LNG['tut_m1_name']                         = 'Tutorial 1 - Os recursos primários';
$LNG['tut_m1_desc']                         = 'Para expandir com sucesso seu planeta, você precisa primeiro garantir uma base sólida de recursos. Otimize a produção dos recursos primários. Melhore a mina de metal e a mina de cristal. Mas lembre-se, a produção consome bastante energia, então não se esqueça da usina solar.<br><br>Você pode construir selecionando "Edifícios" no menu à esquerda.';
$LNG['tut_m1_quest']                        = 'Melhorar a mina de metal para o nível 4';
$LNG['tut_m1_quest2']                       = 'Melhorar a mina de cristal para o nível 2';
$LNG['tut_m1_quest3']                       = 'Melhorar a usina solar para o nível 4';
$LNG['tut_m1_quest4']                       = 'livre';
$LNG['tut_m1_quest5']                       = 'livre';
$LNG['tut_m1_gain']                         = '<font color="orange">Recompensa: 1000 Matéria Escura</font>';
$LNG['tut_m1_ready']                        = 'Parabéns, você completou a missão 1 do tutorial!<br>Você já recebeu 400 Matéria Escura!';
$LNG['tut_m2_name']                         = 'Tutorial 2 - Defesa do planeta';
$LNG['tut_m2_desc']                         = 'Para proteger seus recursos contra ataques inimigos, você precisa construir defesas. Para descobrir o que é necessário, selecione "Tecnologia" no menu à esquerda. Você perceberá rapidamente que precisa de deutério para realizar seu plano. Comece com um sintetizador de deutério...';
$LNG['tut_m2_quest']                        = 'Melhorar o sintetizador de deutério para o nível 2';
$LNG['tut_m2_quest2']                       = 'Melhorar a fábrica de robôs para o nível 2';
$LNG['tut_m2_quest3']                       = 'Construir um estaleiro espacial';
$LNG['tut_m2_quest4']                       = 'Construir 10 lançadores de foguetes';
$LNG['tut_m2_quest5']                       = 'livre';
$LNG['tut_m2_gain']                         = '<font color="orange">Recompensa: 1500 Matéria Escura</font>';
$LNG['tut_m2_ready']                        = 'Parabéns, você completou a missão 2 do tutorial!<br>Você já recebeu 1000 Matéria Escura!';
$LNG['tut_m2_name']                         = 'Tutorial 2 - Defesa do planeta';
$LNG['tut_m2_desc']                         = 'Para garantir que seus recursos estejam protegidos contra ataques inimigos, você precisa construir instalações de defesa. Para descobrir o que é necessário, selecione "Tecnologia" no menu à esquerda. Você rapidamente perceberá que precisa de deutério para realizar suas ações. Comece com um sintetizador de deutério...';
$LNG['tut_m2_quest']                        = 'Melhorar o sintetizador de deutério para o nível 2';
$LNG['tut_m2_quest2']                       = 'Melhorar a fábrica de robôs para o nível 2';
$LNG['tut_m2_quest3']                       = 'Construir um estaleiro espacial';
$LNG['tut_m2_quest4']                       = 'Construir 10 lançadores de mísseis';
$LNG['tut_m2_quest5']                       = 'livre';
$LNG['tut_m2_gain']                         = '<font color="orange">Recompensa: 1500 Matéria Escura</font>';
$LNG['tut_m2_ready']                        = 'Parabéns, você completou a missão 2 do tutorial!<br>Você já recebeu 1000 Matéria Escura!';

$LNG['tut_m3_name']                         = 'Tutorial 3 - Otimizar a produção de recursos';
$LNG['tut_m3_desc']                         = 'É hora de expandir suas minas para produzir mais recursos necessários. Sempre verifique se você tem energia suficiente disponível, caso contrário, a produção será limitada.';
$LNG['tut_m3_quest']                        = 'Melhorar a mina de metal para o nível 10';
$LNG['tut_m3_quest2']                       = 'Melhorar a mina de cristal para o nível 8';
$LNG['tut_m3_quest3']                       = 'Melhorar o sintetizador de deutério para o nível 5';
$LNG['tut_m3_quest4']                       = 'livre';
$LNG['tut_m3_quest5']                       = 'livre';
$LNG['tut_m3_gain']                         = '<font color="orange">Recompensa: 1800 Matéria Escura</font>';
$LNG['tut_m3_ready']                        = 'Parabéns, você completou a missão 3 do tutorial!<br>Você já recebeu 1500 Matéria Escura!';

$LNG['tut_m4_name']                         = 'Tutorial 4 - A primeira nave espacial';
$LNG['tut_m4_desc']                         = 'Naves espaciais, assim como lançadores de mísseis, podem protegê-lo contra inimigos. Mas elas têm uma vantagem enorme: também podem ser usadas para atacar. No entanto, algumas pesquisas são necessárias para construir naves espaciais. Comece sua missão construindo um laboratório de pesquisa...';
$LNG['tut_m4_quest']                        = 'Construir um laboratório de pesquisa';
$LNG['tut_m4_quest2']                       = 'Melhorar o estaleiro espacial para o nível 4';
$LNG['tut_m4_quest3']                       = 'Pesquisar propulsão de combustão até o nível 2';
$LNG['tut_m4_quest4']                       = 'Construir cinco pequenos transportadores';
$LNG['tut_m4_quest5']                       = 'livre';
$LNG['tut_m4_gain']                         = '<font color="orange">Recompensa: 2000 Matéria Escura</font>';
$LNG['tut_m4_ready']                        = 'Parabéns, você completou a missão 4 do tutorial!<br>Você já recebeu 2000 Matéria Escura!';

$LNG['tut_m5_name']                         = 'Tutorial 5 - Comunicação no universo';
$LNG['tut_m5_desc']                         = 'Você não está sozinho nas profundezas do universo! É de grande importância estabelecer uma boa rede de comunicação. Isso permite que você forme alianças com outros jogadores e encontre parceiros comerciais. Muitos jogadores se organizam em alianças para se ajudarem mutuamente. Procure uma aliança adequada no menu à esquerda em "Alianças". Para descobrir quais alianças já existem, dê uma olhada nas estatísticas.';
$LNG['tut_m5_quest']                        = 'Torne-se membro de uma aliança';
$LNG['tut_m5_quest2']                       = 'Envie um pedido de amizade para um amigo ou outro jogador';
$LNG['tut_m5_quest3']                       = 'livre';
$LNG['tut_m5_quest4']                       = 'livre';
$LNG['tut_m5_quest5']                       = 'livre';
$LNG['tut_m5_gain']                         = '<font color="orange">Recompensa: 2500 Matéria Escura</font>';
$LNG['tut_m5_ready']                        = 'Parabéns, você completou a missão 5 do tutorial!<br>Você já recebeu 400 Matéria Escura!';
$LNG['tut_m6_name']                         = 'Tutorial 6 - A primeira expedição';
$LNG['tut_m6_desc']                         = 'O espaço é infinito, e o universo guarda muitos mistérios. Com a ajuda de expedições, você pode explorar o espaço e descobrir recursos adicionais ou até mesmo surpresas inesperadas! Construa pelo menos uma nave de expedição e envie-a para uma posição de expedição no seu sistema estelar.';
$LNG['tut_m6_quest']                        = 'Construir uma nave de expedição';
$LNG['tut_m6_quest2']                       = 'Enviar uma expedição';
$LNG['tut_m6_quest3']                       = 'livre';
$LNG['tut_m6_quest4']                       = 'livre';
$LNG['tut_m6_quest5']                       = 'livre';
$LNG['tut_m6_gain']                         = '<font color="orange">Recompensa: 3000 Matéria Escura</font>';
$LNG['tut_m6_ready']                        = 'Parabéns, você completou a missão 6 do tutorial!<br>Você já recebeu 3000 Matéria Escura!';

$LNG['tut_m7_name']                         = 'Tutorial 7 - Comércio';
$LNG['tut_m7_desc']                         = 'O comércio com outros jogadores é uma ótima maneira de obter os recursos necessários rapidamente. Utilize o mercado ou envie mensagens a outros jogadores para oferecer trocas. Lembre-se de que taxas comerciais justas ajudam a formar boas relações com outros comandantes.';
$LNG['tut_m7_quest']                        = 'Acessar o mercado pelo menu "Mercado"';
$LNG['tut_m7_quest2']                       = 'Colocar uma oferta no mercado';
$LNG['tut_m7_quest3']                       = 'Concluir uma troca bem-sucedida';
$LNG['tut_m7_quest4']                       = 'livre';
$LNG['tut_m7_quest5']                       = 'livre';
$LNG['tut_m7_gain']                         = '<font color="orange">Recompensa: 3500 Matéria Escura</font>';
$LNG['tut_m7_ready']                        = 'Parabéns, você completou a missão 7 do tutorial!<br>Você já recebeu 3500 Matéria Escura!';

$LNG['tut_m8_name']                         = 'Tutorial 8 - A primeira batalha';
$LNG['tut_m8_desc']                         = 'Chegou o momento de testar suas habilidades em batalha. Localize um alvo fácil, como um jogador inativo próximo a você. Certifique-se de que seu alvo não tenha defesas ou uma frota significativa. Envie sua frota com ordens de ataque e conquiste a vitória!';
$LNG['tut_m8_quest']                        = 'Atacar um jogador';
$LNG['tut_m8_quest2']                       = 'Destruir pelo menos 1 unidade de defesa inimiga';
$LNG['tut_m8_quest3']                       = 'Retornar sua frota com recursos saqueados';
$LNG['tut_m8_quest4']                       = 'livre';
$LNG['tut_m8_quest5']                       = 'livre';
$LNG['tut_m8_gain']                         = '<font color="orange">Recompensa: 4000 Matéria Escura</font>';
$LNG['tut_m8_ready']                        = 'Parabéns, você completou a missão 8 do tutorial!<br>Você já recebeu 4000 Matéria Escura!';

$LNG['tut_m9_name']                         = 'Tutorial 9 - Gestão avançada';
$LNG['tut_m9_desc']                         = 'À medida que seu império cresce, a gestão eficiente torna-se mais importante. Certifique-se de utilizar todas as ferramentas disponíveis, como comandos rápidos, organização de frotas e ajustes de produção. O próximo passo será estabelecer colônias para expandir seu poder!';
$LNG['tut_m9_quest']                        = 'Colonizar um novo planeta';
$LNG['tut_m9_quest2']                       = 'Estabelecer minas no novo planeta';
$LNG['tut_m9_quest3']                       = 'Construir pelo menos uma defesa no planeta recém-colonizado';
$LNG['tut_m9_quest4']                       = 'livre';
$LNG['tut_m9_quest5']                       = 'livre';
$LNG['tut_m9_gain']                         = '<font color="orange">Recompensa: 5000 Matéria Escura</font>';
$LNG['tut_m9_ready']                        = 'Parabéns, você completou a missão 9 do tutorial!<br>Você já recebeu 5000 Matéria Escura!';
$LNG['tut_compleat']                        = 'Você completou com sucesso todas as missões!';

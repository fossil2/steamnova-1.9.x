...
<script type="text/javascript">
	...
	<table class="table table-dark table-gow table-sm fs-12 my-1">
		<thead>
    ...
    {/if}
	<table class="table table-dark table-striped table-sm table-gow fs-12">
    <tr>
    ...
    {else}
		...
		<td class="text-center align-middle">
			...
			data-bs-html="true"
			title ="
			<table class='table table-dark table-striped table-gow position-relative fs-11' style='width:220px'>
				<tr>
					<th colspan='2'>
				...
				<img style="border-radius: 200px;-moz-border-radius: 200px;-webkit-border-radius: 200px;" class="hover-border-yellow" src="{$dpath}planeten/{$currentPlanet.planet.image}.jpg" height="30" width="30" alt="">
			</a>
			{/if} <!-- Addon Astéroïdes END IF-->
		</td>
		...
		<td class="text-center align-middle" style="white-space: nowrap;">
			...
			data-bs-placement="right"
			data-bs-html="true"
			 title="<table class='table table-dark table-gow table-sm fs-11' style='width:240px'>
				 <tr>
				 ...
				 <tr>
					 <td style='width:80px'>
						 <img src='{$dpath}planeten/mond.png' height='75' width='75'>
					 </td>
					 <td>
						 <table class='table table-dark table-gow table-sm fs-11' style='width:100%'>
							 <tr>
				...
				<img class="hover-border-yellow" src="{$dpath}planeten/mond.png" height="22" width="22" alt="{$currentPlanet.moon.name}">
			</a>
			{/if}
		</td>
		<td class="text-center align-middle" style="white-space: nowrap;">
        {if $currentPlanet.debris}
			...
			data-bs-placement="right"
			data-bs-html="true"
			 title="<table class='table table-dark table-gow fs-11' style='width:240px'>
				 <tr>
		...
		<td class="text-center align-middle">
		  <a onclick="closePopovers();" class="hover-underline hover-pointer user-select-none"
			...
			data-bs-placement="right"
			data-bs-html="true"
			 title="<table class='table table-dark table-gow fs-11 w-100'>
				 <tr>
		...
		<td class="text-center align-middle" style="white-space: nowrap;">
			...
			data-bs-placement="right"
			data-bs-html="true"
			 title="<table class='table table-dark table-gow fs-11 w-100 px-0'>
				 <tr>
		...
		<td class="text-center align-middle" style="white-space: nowrap;">
			{if $currentPlanet.action}
				{if $currentPlanet.planet.id_owner == NULL} <!-- Addon Astéroïdes -->
					<a href='?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1&amp;target_mission=18'>

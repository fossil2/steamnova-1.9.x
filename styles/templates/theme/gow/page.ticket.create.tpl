...
<table class="table table-dark table-gow table-sm fs-12">
	...
	<tr>
		...
		<td><input class="validate[required]" type="text" id="subject" name="subject" size="40" style="width:99%;" maxlength="45"></td>
	</tr>
	<tr>
		<td><label for="message">{$LNG.ti_message}</label></td>
		<td><textarea class="validate[required]" id="message" name="message" row="60" cols="8" style="height:100px; width:99%; color:white;" maxlength="255"></textarea></td>
	</tr>
	<tr>

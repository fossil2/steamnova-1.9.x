...
<div {if $mode == "defense"}style="background:url('{$dpath}images/defense.webp') no-repeat center center; -webkit-background-size: cover;
-moz-background-size: cover; -o-background-size: cover;background-size: cover;"{else}style="background:url('{$dpath}images/hangar.webp') no-repeat center center; -webkit-background-size: cover;
-moz-background-size: cover; -o-background-size: cover;background-size: cover;"{/if} class="itemShow d-flex justify-content-center align-items-center w-100 bg-black position-relative border-gray">
...
<div class="d-flex flex-wrap justify-content-start bg-black pb-2 border-gray">
  <div class="d-flex w-100 justify-content-center m-2">
    <span class="color-yellow fs-12 fw-bolt">{if $mode == "fleet"}{$LNG.lm_shipshard}{else}{$LNG.lm_defenses}{/if}</span>  

...
{block name="content"}
<table class="table table-dark table-sm table-gow my-1">
	<tr>
...
<table id="messagestable" class="table table-dark table-sm table-gow my-1">
	<tr>
...
<table id="messagestable" class="table table-dark table-sm table-gow">
	<tr style="height:20px;">

  ...
  <table class="table table-dark table-sm fs-12 table-gow">
    ...
    {if !empty($news)}
      ...
      <tr id="newsRow" class="{if $show_news_active}d-none{/if}">
        <td colspan="2">
          <table class="table table-dark table-gow fs-12">
            <thead>
              <tr>
    ...
    <tr>
        ...
        <div class="d-flex flex-row align-items-center justify-content-center  fs-12">
          <div class="d-flex flex-column align-items-center justify-content-center w-100">
            ...
            <a class="hover-pointer" href="?page=overview&cp={$planet_id}">
              <img src="{$dpath}planeten/{$planetimage}.jpg" height="120" width="120" alt="{$planetname}">
            </a>
          </div>
          {if $Moon}
          <div class="d-flex flex-column align-items-center justify-content-center w-100">
      ...
      <td>
        <table class="table table-dark table-gow table-sm my-2">
          <thead></thead>
          <tbody class="fs-12">
            <tr>
...
<table class="table table-dark table-sm table-gow my-2">
  <tr>
    <td class="text-center">

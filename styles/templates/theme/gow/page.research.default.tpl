...
<div style="background:url('{$dpath}images/research.webp') no-repeat center center; -webkit-background-size: cover;
-moz-background-size: cover; -o-background-size: cover;background-size: cover;" class="itemShow d-flex justify-content-center align-items-center w-100 bg-black position-relative border-gray">
      ...
      <div class="bg-blue d-flex justify-content-start mb-2 text-white fw-bold">
        <div class="d-flex px-2">
          <span class="fs-12 {if $Element.costOverflowTotal > 0}color-red hover-pointer{else}color-yellow{/if} p-0" {if $Element.costOverflowTotal > 0} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-html="true" title="
            <table class='table table-dark fs-12'>
              <thead>
...
<div class="d-flex flex-wrap justify-content-start bg-black pb-2 border-gray">
  ...
  <div class="mx-2 d-flex flex-wrap justify-content-center">
      ...
      <table class='table-dark table-tooltip'>
        <thead>

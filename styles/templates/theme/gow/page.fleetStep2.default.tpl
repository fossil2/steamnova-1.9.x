...
<input type="hidden" name="token" value="{$token}">
   	<table class="table table-dark table-gow table-sm fs-12">
        <tr>
      ...
      <td class="text-center">{$LNG.fl_resources}</td>
		...
		<tr>
    		...
    		<table class="table table-dark table-gow table-sm" border="0" cellpadding="0" cellspacing="0" style="margin:5px 0;padding:0;">
      ...
      <td class="w-50">
				<table class="table table-dark table-gow table-sm fs-12" border="0" cellpadding="0" cellspacing="0" style="margin:5px 0;padding:0;">
              <tr colspan="5">
		...
		<tr style="height:20px;">
			<td>
				<table class="table table-dark table-gow table-sm">
				<tr class="no-border">
					<td >
						<select name="resEx">

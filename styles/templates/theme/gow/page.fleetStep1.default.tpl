...
<form action="game.php?page=fleetStep2" method="post" onsubmit="return CheckTarget()" id="form">
	...
	<table class="table table-dark table-gow table-sm fs-12" style="table-layout: fixed;">
...
<table class="table table-dark table-gow table-sm fs-12">
	...
	{/if}
	<table class="table table-dark table-gow table-sm table-striped fs-12" style="table-layout: fixed;">
		<tr style="height:20px;">
	...
	{if $ACSList}
	<table class="table table-dark table-gow" style="table-layout: fixed;">
		<tr style="height:20px;">

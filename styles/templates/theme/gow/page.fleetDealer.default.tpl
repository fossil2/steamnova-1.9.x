        ...
        <tr>
			<td>
				...
				<div style="clear:right;margin-top:20px;margin-left:125px;">
					<h2 id="traderHead"></h2>
					<p>{$LNG.ft_count}: <input type="text" class="text-center text-yellow" id="count" name="count" onkeyup="Total();"><button class="text-center text-yellow" onclick="MaxShips();return false;">{$LNG.ft_max}</button></p>

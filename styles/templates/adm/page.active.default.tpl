...
<tr>
	...
	<td>
		<a href="?page=active&amp;aktion=delete&id={$User.id}" onclick="return confirm('{$LNG.ap_sicher}{$User.name} {$LNG.ap_entfernen}');">
			<img border="0" src="./styles/resource/images/alliance/CLOSE.png" width="16" height="16">
		</a>
	</td>
</tr>
{/foreach}

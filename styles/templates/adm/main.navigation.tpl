...
<div id="leftmenu">
	...
	<ul class="bg-dark d-flex flex-column p-0 m-0" id="menu">
		<li><a><span style="color:lime">{$LNG.mu_general}</span></a></li>
    ...
    {if allowedTo('ShowPlanetFieldsPage')}
			<li class="d-flex {if $currentPage == 'planetFields'}menu-active{/if}">
				<a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6" href="?page=planetFields" >{$LNG.mu_planet_fields}</a>
			</li>
		{/if}
    ...
    {/if}
    <li><a><span style="color:lime">{$LNG.mu_mods}</span></a></li>
    {if allowedTo('ShowBostPage')}
			<li class="d-flex {if $currentPage == 'bots'}menu-active{/if}">
				<a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6" href="?page=bots" >{$LNG.mu_bots}</a>
			</li>
		{/if} 
		
		 {if allowedTo('ShowEditbotsPage')}
    <li class="d-flex {if $currentPage == 'Bot-Aktionen'}menu-active{/if}">
      <a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6" href="?page=botsTasks" >Bot-Aktionen</a>
    </li>             
  {/if} 
		
    {if allowedTo('ShowModAsteroidPage')}
    ...
    {/if}
    <li><a><span style="color:lime">{$LNG.mu_observation}</span></a></li>
    ...
    {/if}
    <li><a><span style="color:lime">{$LNG.mu_tools}</span></a></li>

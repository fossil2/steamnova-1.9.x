...
define('DISCORD_URL'				, 'https://discord.gg/buzwPuna');
...
define('INACTIVE'					, 904800);

// TIME IN SECONDS, TO (i I) APPEAR ON GALAXY
define('INACTIVE_LONG'				, 4419200);
...
define('MODULE_QUEST'              , 54);
define('MODULE_FORUM'              , 52);
define('MODULE_SERVER_INFO'        , 53);
define('MODULE_AMOUNT'             , 55);
// FLEET STATE
